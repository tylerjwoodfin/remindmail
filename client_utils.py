...
def authenticate() -> httplib2.Http:
    ...
    try:
        ...
        securedata.log("Missing Google client ID/client secret; see https://github.com/jonahar/google-reminders-cli and store these in securedata (pip3 install securedata)", level="error")
        exit(-1)
